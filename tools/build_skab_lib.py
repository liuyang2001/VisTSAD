...
OUTPUT_DIR = Path("data/resources_skab")
...
def main():
    print(">>> Building SKAB Reference Library (Global Normalization)...")
    ...
    all_raw = [pd.read_csv(f, sep=None, engine='python').iloc[:, :NUM_VARS].values for f in all_files]
    ...
    print(f"   [Done] SKAB Library saved to {save_path}")
