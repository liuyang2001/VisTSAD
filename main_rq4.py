...
def parse_args():
    ...
    ap.add_argument("--EU1", type=float, default=0.45, help="EU lower threshold (default: 0.50)")
    ap.add_argument("--EU2", type=float, default=0.50, help="EU upper threshold (default: 0.55)")
    ap.add_argument("--MI1", type=float, default=0.75, help="MI lower threshold (default: 0.80)")
    ap.add_argument("--MI2", type=float, default=0.80, help="MI upper threshold (default: 0.85)")
